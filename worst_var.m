...
plot((E),(gldp(1,:)-ldp(1,:))./ldp(1,:),':ro')
hold on
xlabel("n")
ylabel("Var")
% save ./data/var_worst2_e_n1k.mat var_RR var_pro est_pro0 est_pro1 est_rr0 est_rr1 ldp gldp n1 n0
% save ./data/var_worst2_e_n20k.mat var_RR var_pro est_pro0 est_pro1 est_rr0 est_rr1 ldp gldp n1 n0
% save ./data/var_worst2_e_n40k.mat var_RR var_pro est_pro0 est_pro1 est_rr0 est_rr1 ldp gldp n1 n0
% save ./data/var_worst2_e_n80k.mat var_RR var_pro est_pro0 est_pro1 est_rr0 est_rr1 ldp gldp n1 n0
