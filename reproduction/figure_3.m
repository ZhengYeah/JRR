...
load ../effect_epsilon/estimated_n10k_f001.mat
var_pro_f001 = [];
...
load ../effect_epsilon/estimated_n40k_f001.mat
...
load ../effect_epsilon/estimated_n80k_f001.mat
...
load ../effect_epsilon/estimated_n10k_f01.mat
var_pro_f01 = [];
...
load ../effect_epsilon/estimated_n40k_f01.mat
...
load ../effect_epsilon/estimated_n80k_f01.mat
...
%% display of MSE
figure
plot(log10(E), log10(var_rr_f001(1, :)), '-bd', 'LineWidth', 2, 'Markersize', 8)
hold on
plot(log10(E), log10(var_pro_f001(1, :)), '-ro', 'LineWidth', 2, 'Markersize', 8)
hold on
plot(log10(E), log10(var_pro_f01(1, :)), '-g*', 'LineWidth', 2, 'Markersize', 8)
hold on
plot(log10(E), log10(var_pro_f1(1, :)), '-m+', 'LineWidth', 2, 'Markersize', 8)
...
%% display of RE
figure
plot(log10(E),log10(re_rr1),':bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro1),'-bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_rr1_f01),':r+','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro1_f01),'-r+','LineWidth',2,'Markersize',8)
hold on
...
figure
plot(log10(E),log10(re_rr2),':bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro2),'-bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_rr2_f01),':r+','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro2_f01),'-r+','LineWidth',2,'Markersize',8)
hold on
h=legend("RR ($n_1/n=0.01$)","JRR ($n_1/n=0.01$)","RR ($n_1/n=0.1$)","JRR ($n_1/n=0.1$)",'location','NE',Interpreter='latex');
xlabel("$\varepsilon$",Interpreter='latex')
ylabel("ARE")
...
figure
plot(log10(E),log10(re_rr4),':bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro4),'-bd','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_rr4_f01),':r+','LineWidth',2,'Markersize',8)
hold on
plot(log10(E),log10(re_pro4_f01),'-r+','LineWidth',2,'Markersize',8)
hold on
h=legend("RR ($n_1/n=0.01$)","JRR ($n_1/n=0.01$)","RR ($n_1/n=0.1$)","JRR ($n_1/n=0.1$)",'location','NE',Interpreter='latex');
xlabel("$\varepsilon$",Interpreter='latex')
ylabel("ARE")
